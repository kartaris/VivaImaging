...
LPCTSTR pszEncryptPassword = _T("12!@#$%^78&*");

BOOL KEncryptFile(LPCTSTR pszSourceFile, LPCTSTR pszDestinationFile)
{
  //---------------------------------------------------------------
  ...
  if (!pszEncryptPassword || !pszEncryptPassword[0])
  {
    //-----------------------------------------------------------
  ...
  else
  {
    ...
    if (CryptHashData(
      hHash,
      (BYTE *)pszEncryptPassword,
      lstrlen(pszEncryptPassword),
      0))
    {
      _tprintf(
...
BOOL KDecryptFile( LPCTSTR pszSourceFile, LPCTSTR pszDestinationFile)
{
  //---------------------------------------------------------------
  // Declare and initialize local variables.
  BOOL fReturn = FALSE;
